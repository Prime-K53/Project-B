          ...
          {batch_details?.schoolName && (
            <>
              ...
              {batch_details?.numberOfStudents && (
                <span> with <span className="font-semibold">{batch_details.numberOfStudents.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} students</span></span>
              )}
