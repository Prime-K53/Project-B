            ...
            <div className="flex-1 min-w-0">
              <div className="flex justify-between items-start mb-0.5">
                ...
                <span className="text-[10px] font-black text-slate-900 finance-nums">
                  {currency}{account.balance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </span>
              </div>
      ...
      <div className="mt-4 pt-4 border-t border-slate-50 px-1">
        <div className="flex items-center justify-between text-[9px] font-bold text-slate-400 uppercase tracking-wider">
          ...
          <span className="text-blue-600">
            {currency}{accountsData.reduce((sum, acc) => sum + acc.balance, 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
          </span>
        </div>
      </div>
    </div>
