          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center text-[12px]">
              ...
              <span className="font-bold text-slate-800">
                {classBreakdown.reduce((sum, cls) => sum + cls.totalCandidates, 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
              </span>
            </div>
      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-100">
          <div>
            ...
            <p className="text-sm font-bold text-slate-800">{classData.totalCandidates.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
          </div>
          <div>
        ...
        <div className="mt-4 p-3 bg-blue-50/50 rounded-xl border border-blue-100/50">
          <p className="text-[10px] text-blue-700 font-medium">
            <span className="font-bold">Calculation:</span> {classData.totalCandidates} learners Ã— {currencySymbol}{classData.chargePerLearner.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} = {currencySymbol}{classData.classTotal.toLocaleString(undefined, { minimumFractionDigits: 2 })}
          </p>
        </div>
      </div>
    </div>
