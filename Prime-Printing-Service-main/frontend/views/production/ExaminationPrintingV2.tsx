                  ...
                  <div className="divide-y divide-slate-100">
                    {subjectRowsPreview.map((subject, index) => (
                      <div key={subject.id || `new-${index}`} className="grid grid-cols-12 gap-2 px-4 py-3 items-center">
                        ...
                        <div className="col-span-3 text-sm font-semibold text-slate-700">{subject.total_pages.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} pages</div>
                ...
                <div className="bg-slate-50 rounded-xl border border-slate-200 p-3">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                    <div className="p-2 bg-white rounded-lg border border-slate-200">
                      ...
                      <p className="text-sm font-black">{localTotalPages.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                    </div>
                    <div className="p-2 bg-white rounded-lg border border-slate-200">
                ...
                <div className={`rounded-xl border p-3 ${editingJob.override_enabled ? 'bg-amber-50 border-amber-200' : 'bg-slate-50 border-slate-200'}`}>
                        ...
                        return (
                          <div className="mt-3 p-2 bg-red-50 border border-red-200 rounded-lg">
                            <p className="text-xs text-red-700 font-semibold">
                              âš ï¸ Calculation Discrepancy Detected
                            </p>
                  ...
                  <div className="mt-3 text-xs">
                    ...
                    {(editingJob.margin_impact || 0) < -10 && (
                      <span className="ml-2 text-red-600 font-semibold">âš ï¸ Significant margin reduction</span>
                    )}
                  </div>
                </div>
        ...
        <div className="space-y-5">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="flex gap-6 text-sm">
                <div className="text-right">
                  ...
                  <p className="font-bold text-white">{reportingSummary.totalLearners.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
                <div className="text-right">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-3">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-4">
              ...
              <p className="text-2xl font-black text-slate-900">{reportingSummary.totalLearners.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
              <p className="text-xs text-slate-500 mt-2">{reportingSummary.totalPages.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} pages</p>
            </div>
            <div className="bg-white rounded-2xl border border-slate-200 p-4">
                  ...
                  <tbody>
                    {reportingBySchool.map(row => (
                      <tr key={row.school_id} className="border-b border-slate-100">
                        ...
                        <td className="py-2">{row.learners.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                        <td className="py-2">{row.pages.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
