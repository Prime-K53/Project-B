      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-[12px] w-full md:w-auto">
          ...
          <div className="bg-white border border-slate-200 rounded-lg px-3 py-2">
            ...
            <p className="text-slate-900 font-semibold">{currency}{totalPipelineValue.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
          </div>
          <div className="bg-white border border-slate-200 rounded-lg px-3 py-2">
                ...
                <div key={lead.id} className="border border-slate-200 rounded-lg p-2 bg-white shadow-sm">
                  ...
                  <div className="mt-2 space-y-1 text-[11px]">
                    <div className="flex items-center gap-1 text-slate-600">
                      <DollarSign size={12} />
                      <span>{currency}{Number(lead.estimatedDealValue || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                    </div>
                    <div className="flex items-center gap-1 text-slate-600">
                      <Calendar size={12} />
