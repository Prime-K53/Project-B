                        ...
                        {filteredResults.invoices.map(inv => (
                          ...
                          >
                            ...
                            <div className="text-right">
                              <div className="text-sm font-bold text-gray-900">${inv.totalAmount?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-50">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-lg font-black text-indigo-600">${inv.totalAmount?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                        </div>
                      </div>
                    </div>
                  ))}
                    ...
                    {returnItems.map((item, idx) => (
                      <tr key={idx} className={item.qty_to_return > 0 ? 'bg-indigo-50/30' : ''}>
                        <td className="px-4 py-3">
                          ...
                          <div className="text-xs text-gray-500">Unit Price: ${item.rate?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                        </td>
