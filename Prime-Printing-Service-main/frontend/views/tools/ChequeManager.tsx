                                ...
                                <tbody className="divide-y divide-slate-100">
                                    {filteredCheques.map(c => (
                                        <tr key={c.id} className="hover:bg-slate-50 transition-colors">
                                            ...
                                            <td className="p-4 text-right font-mono font-bold text-slate-800">{currency}{c.amount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                         ...
                         <div className="flex-1 p-8 bg-slate-200 overflow-auto flex items-center justify-center">
                            ...
                            >
                                ...
                                <div className="absolute text-lg font-bold font-mono" style={{ left: `${printConfig.amountFigPos.x}mm`, top: `${printConfig.amountFigPos.y}mm` }}>
                                    {editingCheque.amount ? `**${editingCheque.amount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}**` : '0.00'}
                                </div>
                            </div>
                        </div>
                    </div>
