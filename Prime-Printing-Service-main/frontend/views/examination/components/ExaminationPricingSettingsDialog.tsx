                      ...
                      {preview.classes.map((classPreview) => (
                        <div key={classPreview.classId} className="rounded-lg border border-blue-100 bg-white p-3">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-xs font-medium text-blue-800">{classPreview.learners.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} learners</span>
                          </div>
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm">
                            <div className="rounded-md bg-blue-50/60 px-3 py-2 border border-blue-100">
                              ...
                              <div className="font-semibold text-slate-900">{classPreview.totalSheets.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                            </div>
                            <div className="rounded-md bg-blue-50/60 px-3 py-2 border border-blue-100">
                              <div className="text-xs text-slate-500">Total Pages</div>
                              <div className="font-semibold text-slate-900">{classPreview.totalPages.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                            </div>
                            <div className="rounded-md bg-blue-50/60 px-3 py-2 border border-blue-100">
                              <div className="text-xs text-slate-500">Total BOM Cost</div>
                              <div className="font-semibold text-slate-900">{classPreview.totalBomCost.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                            </div>
                            <div className="rounded-md bg-blue-50/60 px-3 py-2 border border-blue-100">
                              <div className="text-xs text-slate-500">Total Adjustments</div>
                              <div className="font-semibold text-slate-900">{classPreview.totalAdjustments.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                            </div>
                            <div className="rounded-md bg-blue-50/60 px-3 py-2 border border-blue-100">
                              <div className="text-xs text-slate-500">Total Cost</div>
                              <div className="font-semibold text-slate-900">{classPreview.totalCost.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                            </div>
                            <div className="rounded-md bg-white px-3 py-2 border border-blue-200">
                              ...
                              <div className="font-semibold text-blue-900">{classPreview.expectedFeePerLearner.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                            </div>
                          </div>
                        </div>
                      ))}
