                      ...
                      <label key={job.id} className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded cursor-pointer">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-gray-600">
                            {job.number_of_learners} learners | {companyConfig?.currencySymbol || 'MWK'} {job.final_amount?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                          </div>
                        </div>
                      </label>
                    ))
              ...
              <>
                <div className="space-y-3">
                  {selectedJobs.map((job) => (
                    <div key={job.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="font-semibold">{companyConfig?.currencySymbol || 'MWK'} {job.final_amount?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                        <Button
                          variant="ghost"
                          size="sm"
                ...
                <div className="border-t pt-4 space-y-2">
                  ...
                  <div className="flex justify-between text-lg font-bold border-t pt-2">
                    ...
                    <span>{companyConfig?.currencySymbol || 'MWK'} {totalAmount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
                </div>
              ...
              {groups.map((group) => (
                <div key={group.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                  ...
                  <div className="text-sm text-gray-600 mb-3">
                    {group.jobs.length} jobs | {companyConfig?.currencySymbol || 'MWK'} {group.total_amount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                  </div>
