    ...
    <div className="h-full overflow-y-auto">
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-2">
          {isEditing && currentJob && (
            <span className="text-sm text-gray-600">
              Last updated: {new Date(currentJob.updated_at || currentJob.created_at).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </span>
          )}
        </div>
            ...
            <div className="mt-4 p-4 bg-slate-800 rounded-lg text-white">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  ...
                  <div className="text-lg font-bold">{totalSheets.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                </div>
                <div>
                  <div className="text-xs text-slate-400">Total Pages</div>
                  <div className="text-lg font-bold">{totalPages.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                </div>
                <div>
