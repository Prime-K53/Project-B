          ...
          <div className="p-[24px] border-b border-slate-200 bg-slate-50 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-emerald-600">+{currency}{cashFlowSummary.income.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-slate-500">Expenses</span>
                <span className="font-semibold text-rose-600">-{currency}{cashFlowSummary.expenses.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
              <div className="flex items-center gap-2">
                  ...
                  {statements.map(stmt => {
                    ...
                    return (
                      <tr key={stmt.id} className="hover:bg-slate-50">
                        ...
                        <td className="p-4 font-mono text-emerald-600">{currency}{stmt.startingBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                        <td className="p-4 font-mono text-blue-600">{currency}{stmt.endingBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                        <td className="p-4 font-mono text-green-600">{currency}{stmt.totalDeposits.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                        <td className="p-4 font-mono text-red-600">{currency}{stmt.totalWithdrawals.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                        <td className="p-4">
                ...
                <tbody className="divide-y divide-slate-100">
                  {scheduledRows.map(row => (
                    <tr key={row.id} className="hover:bg-slate-50">
                      ...
                      <td className="p-4 font-mono font-bold">{currency}{row.amount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                      <td className="p-4">
                        <span className={`px-2 py-1 rounded text-xs font-medium ${
                ...
                <tbody className="divide-y divide-slate-100">
                  {reconciliations.map(rec => (
                    <tr key={rec.id} className="hover:bg-slate-50">
                      ...
                      <td className="p-4 font-mono">{currency}{rec.endingBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                       <td className="p-4 font-mono">{currency}{rec.bookBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                       <td className="p-4 font-mono">
                         <span className={rec.difference === 0 ? 'text-emerald-600' : 'text-rose-600'}>
                           {currency}{Math.abs(rec.difference).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                         </span>
                       </td>
                      <td className="p-4">
                        <span className={`px-2 py-1 rounded text-xs font-medium ${
                ...
                {visibleForecasts.map(forecast => (
                  <div key={forecast.id} className="bg-slate-50 p-6 rounded-xl border border-slate-200">
                    ...
                    <div className="text-2xl font-bold text-slate-900 mb-4">
                       {currency}{forecast.projectedBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                     </div>
                     <div className="grid grid-cols-2 gap-4 text-sm">
                       <div>
                         <div className="text-slate-400">Income</div>
                         <div className="font-medium text-emerald-600">+{currency}{forecast.income.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                       </div>
                       <div>
                         <div className="text-slate-400">Expenses</div>
                         <div className="font-medium text-rose-600">-{currency}{forecast.expenses.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                       </div>
                     </div>
                  </div>
                ))}
              ...
              {reconciliationPreview && (
                <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{currency}{reconciliationPreview.startingBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500">Book Balance</span>
                    <span className="font-medium">{currency}{reconciliationPreview.bookBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500">Cleared Balance</span>
                    <span className="font-medium">{currency}{reconciliationPreview.clearedBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500">Difference</span>
                    <span className={reconciliationPreview.difference === 0 ? 'font-medium text-emerald-600' : 'font-medium text-rose-600'}>
                      {currency}{Math.abs(reconciliationPreview.difference).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                    </span>
                  </div>
                </div>
              )}
              ...
              {forecastPreview && (
                <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{currency}{forecastPreview.baseBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500">Scheduled Income</span>
                    <span className="font-medium text-emerald-600">+{currency}{(forecastPreview.income - forecastPreview.recurringIncome).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500">Recurring Income</span>
                    <span className="font-medium text-emerald-600">+{currency}{forecastPreview.recurringIncome.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-slate-500">Scheduled Expenses</span>
                    <span className="font-medium text-rose-600">-{currency}{forecastPreview.expenses.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
                  <div className="flex items-center justify-between border-t border-slate-200 pt-2 mt-2">
                    <span className="text-slate-600 font-semibold">Projected Balance</span>
                    <span className="font-semibold">{currency}{forecastPreview.projectedBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </div>
                </div>
              )}
              <div className="flex justify-end gap-2 pt-2">
