      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-6 shrink-0">
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
          ...
          <p className="text-2xl font-bold text-blue-600">
            {currency}{filteredTransfers.reduce((sum, t) => sum + t.amount, 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
          </p>
        </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-slate-500">
                            Balance: {currency}{accountBalances[transfer.fromAccountId]?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) || '0.00'}
                          </div>
                        </div>
                      </div>
                    </td>
                    <td className="p-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-slate-500">
                            Balance: {currency}{accountBalances[transfer.toAccountId]?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) || '0.00'}
                          </div>
                        </div>
                      </div>
                    </td>
                    ...
                    {activeBankAccounts
                      ...
                      .map(account => (
                        <option key={account.id} value={account.id}>
                          {account.name} (Balance: {currency}{(accountBalances[account.id] || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })})
                        </option>
                      ))}
                  </select>
                </div>
            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 p-4 rounded-lg">
                  ...
                  <div className="font-bold text-lg text-slate-900">{currency}{selectedTransfer.amount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                </div>
              </div>
