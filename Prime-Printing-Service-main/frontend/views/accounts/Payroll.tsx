                            ...
                            <tbody className="divide-y divide-slate-100">
                                {runPayslips.map(ps => (
                                    <tr key={ps.id} className="hover:bg-slate-50">
                                        ...
                                        <td className="p-4 text-right font-bold text-emerald-600">{currency}{ps.netPay.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                            ...
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-bold">{currency}{estTotalPayroll.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                            </div>
                        </div>
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {activeEmployees.map(emp => (
                                    <tr key={emp.id}>
                                        ...
                                        <td className="p-4 text-right font-mono">{currency}{emp.basicSalary.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {payrollRuns.slice().reverse().map(run => (
                                <tr key={run.id} className="hover:bg-slate-50">
                                    ...
                                    <td className="p-4 text-right text-slate-600">{currency}{run.totalBasic.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                                    <td className="p-4 text-right font-bold text-emerald-600">{currency}{run.totalNetPay.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
