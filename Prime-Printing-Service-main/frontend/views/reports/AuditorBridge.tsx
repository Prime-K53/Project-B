        ...
        <div className="bg-slate-900 rounded-[2rem] p-8 text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <p className="text-slate-400 text-sm mb-6 max-w-lg leading-relaxed">
                    Detected a valuation variance of <span className="text-white font-bold">{currency}{(drift || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>.
