      ...
      <section className="bg-white border border-slate-200 rounded-xl p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-sm">
          ...
          <div>
            ...
            <p className="font-semibold">{Number(summary?.products_with_rounding || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
          </div>
        </div>
      </section>
            ...
            <tbody>
              {productRows.map((row) => (
                <tr key={buildHistoryKey(row.product_id, row.variant_id)} className="border-b border-slate-100">
                  ...
                  <td className="py-2">{Number(row.qty_sold || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
              ...
              <tbody>
                {dailyRows.map((row) => (
                  <tr key={row.period} className="border-b border-slate-100">
                    ...
                    <td className="py-2">{Number(row.products_updated || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
