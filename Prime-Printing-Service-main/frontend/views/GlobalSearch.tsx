                ...
                renderItem={(sale: any) => ({
                    ...
                    content: (
                        <div>
                            ...
                            <div className="text-xs text-slate-600 mt-1">Total: {toSafeNumber(sale.total ?? sale.totalAmount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                        </div>
                    )
                })}
            />
