            ...
            {hasVariants && (
                <div className="px-6 py-2 bg-blue-50/50 border-b border-blue-100 flex items-center gap-3">
                    ...
                    <span className="text-[11px] text-blue-500">
                        Total Stock: {variantTotalStock.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {item.unit}
                    </span>
                    {topVariant && (
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div className="bg-white/70 backdrop-blur-xl p-4 rounded-2xl border border-white/60">
                                        ...
                                        <div className="text-[24px] font-black text-blue-600 finance-nums">{variantTotalStock.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                                    </div>
                                    <div className="bg-white/70 backdrop-blur-xl p-4 rounded-2xl border border-white/60">
                                        <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Total Units Sold</div>
                                        <div className="text-[24px] font-black text-emerald-600 finance-nums">{variantSalesData.reduce((sum, v) => sum + v.unitsSold, 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                                    </div>
                                    <div className="bg-white/70 backdrop-blur-xl p-4 rounded-2xl border border-white/60">
                                        <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Total Revenue</div>
                                        <div className="text-[24px] font-black text-blue-600 finance-nums">{currency}{variantSalesData.reduce((sum, v) => sum + v.revenue, 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                                    </div>
                                </div>
                                ...
                                {topVariant && topVariant.unitsSold > 0 && (
                                    <div className="bg-gradient-to-r from-emerald-50 to-blue-50 p-4 rounded-2xl border border-emerald-100 flex items-center gap-4">
                                        ...
                                        <div className="ml-auto text-right">
                                            <div className="text-[20px] font-black text-emerald-600 finance-nums">{topVariant.unitsSold.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                                                        ...
                                                        <tr key={v.id} className={`hover:bg-slate-50/50 transition-colors ${isTopSeller ? 'bg-emerald-50/30' : ''}`}>
                                                            ...
                                                            <td className="table-body-cell py-3 px-4 text-center">
                                                                <span className={`font-bold finance-nums ${isLowStock ? 'text-red-600' : 'text-slate-700'}`}>
                                                                    {v.stock.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                                                </span>
                                                            ...
                                                            <td className="table-body-cell py-3 px-4 text-right font-bold finance-nums">{v.unitsSold.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
