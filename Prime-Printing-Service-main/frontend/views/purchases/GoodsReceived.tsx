                  ...
                  {(editingGrn.landingCosts?.length || 0) > 0 && (
                      <div className="mb-10 animate-in fade-in slide-in-from-top-4">
                          ...
                          <div className="mt-4 p-4 bg-slate-900 rounded-2xl flex justify-between items-center">
                              ...
                              <span className="text-[24px] font-bold text-white finance-nums">{currency}{(editingGrn.landingCosts?.reduce((s,c)=>s+(c.amount || 0),0) || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                          </div>
                      </div>
                  )}
