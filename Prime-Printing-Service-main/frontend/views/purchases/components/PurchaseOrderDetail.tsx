                        ...
                        <div id="po-printable" className="max-w-5xl mx-auto space-y-10 animate-in fade-in duration-300">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm">
                                    ...
                                    <div className="text-[24px] font-bold text-slate-900 finance-nums">{currency}{(purchase.total || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                                </div>

                                <div className="bg-slate-900 p-8 rounded-[2.5rem] shadow-xl text-white">
                                    <div className="text-[10px] font-bold text-blue-400 uppercase tracking-tight mb-1">Landed Total</div>
                                    <div className="text-[24px] font-bold finance-nums">{currency}{((purchase.total || 0) + (landingTotal || 0)).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
                                </div>
                            </div>
                                    ...
                                    <div className="p-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                                        {purchase.landingCosts.map(cost => (
                                            <div key={cost.id} className="p-3 bg-slate-50 rounded-xl border border-slate-100">
                                                ...
                                                <p className="text-[13px] font-bold text-slate-900 finance-nums">{currency}{(cost.amount || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
