...
import { formatNumber, formatShortCurrency } from '../utils/helpers';
import {
...
// â”€â”€â”€ CSS keyframes injected once â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const formatShortCurrency = (currency: string, value: number): string => {
  ...
  return `${curr} ${formatNumber(value)}`;
};
...
// â”€â”€â”€ period map â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Premium KPI Card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const PremiumKpiCard = ({
  ...
  // Trigger staggered value animation â€” each card fires at a unique interval
  useEffect(() => {
...
// â”€â”€â”€ Sliding Info Card component â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ KPI card alias â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const SimpleKpiCard = PremiumKpiCard;

// â”€â”€â”€ Animated value wrapper for custom-child KPI cards â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ KPI card (old design - keeping for reference if needed) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ period dropdown â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const DashboardContent: React.FC = () => {
  ...
  // â”€â”€ Company Menu & Restore Logic â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Search Live Preview Logic â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ account balances â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // 1. Revenue (This Month) â€” posted invoice value in current calendar month
  ...
  // 2. Today's Collection â€” payments received today (customerPayments)
  ...
  // 3. Receivables â€” outstanding balance on unpaid/partial invoices
  ...
  // 4. Active Jobs â€” count open job orders + active work orders
  const activeJobs = (() => {
  ...
  // â”€â”€ sparkline seeds â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ sliding slides â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  const infoSlides = [
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, height: '100%' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ fontSize: 11, color: '#64748b', fontWeight: 500, marginTop: 4 }}>
              {nextSubscription ? `${nextSubscription.customerName || 'Company account'} Â· ${nextSubscription.frequency || 'Pro'}` : 'Prime ERP Management System'}
            </div>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ fontSize: 11, color: '#0f172a', fontWeight: 700 }}>
              {nextSubscription ? format(new Date(nextSubscription.nextDueDate || nextSubscription.nextBillingDate || nextSubscription.dueDate), 'MMM d, yyyy') : 'â€”'}
            </div>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ fontSize: 10, fontWeight: 700, color: '#b45309', backgroundColor: '#fffbeb', padding: '1px 8px', borderRadius: 6 }}>
              {nextSubscription ? formatShortCurrency(toSafeNumber(nextSubscription.totalAmount), currency) : 'K0'}
            </div>
          </div>
        </div>
      )
    ...
    {
      label: `Weather Â· ${companyConfig?.city || 'Blantyre'}`,
      color: '#0ea5e9',
      icon: <Sun size={20} />,
      render: (compact: boolean) => (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, height: '100%' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ fontSize: 11, fontWeight: 700, color: '#64748b', letterSpacing: '0.05em', textTransform: 'uppercase' }}>
              WEATHER Â· {companyConfig?.city?.toUpperCase() || 'BLANTYRE'}
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ fontSize: 11, color: '#64748b', fontWeight: 500, marginTop: 4 }}>
              {weather.cond} Â· {companyConfig?.city || 'Local area'}
            </div>
          </div>
          <div style={{ height: '1px', backgroundColor: 'rgba(0,0,0,0.06)', width: '100%', margin: '2px 0' }} />
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
  ...
  // â”€â”€ chart data load â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  return (
    ...
    >
      ...
      {/* â”€â”€ Main Dashboard Card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <div
        style={{
      ...
      >
        {/* â”€â”€ Top Bar: glassmorphism â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        <div style={{
          display: 'flex',
          justifyContent: 'space-between',
          alignItems: 'center',
          ...
          {/* Search â€” pill style, hidden on mobile */}
          {!isMobile && (
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12 }}>
            {/* Action Buttons â€” icon only on mobile */}
        ...
        {/* â”€â”€ Date, Greeting and Reports Button â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        <div style={{
        ...
        {/* â”€â”€ Main Content: KPIs + Chart â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
        <div
          style={{
            display: 'grid',
        ...
        >
          {/* Left Column: KPI Cards Grid â€” 2Ã—2 */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: isMobile ? 12 : 24 }}>
            {/* Card 1 â€” Company Overview (Sliding) */}
            <SlidingInfoCard
              slides={infoSlides}
              compact={isMobile}
              animDelay={8000}
            />
            {/* Card 2 â€” Today's Collection */}
            <PremiumKpiCard
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <KpiValueAnimator animDelay={2000}>
                  <div style={{
                    ...
                    {formatShortCurrency(todaysCollection, currency)}
                  </div>
                </KpiValueAnimator>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <KpiValueAnimator animDelay={4000}>
                  <div style={{
                    ...
                    {formatShortCurrency(revenueThisMonth, currency)}
                  </div>
                </KpiValueAnimator>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <div style={{ fontSize: 11, color: '#64748b', fontWeight: 700 }}>
                    Goal: <span style={{ color: '#0f172a' }}>{formatShortCurrency(companyConfig?.monthlyRevenueTarget || 50000, currency)}</span>
                  </div>
                </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <KpiValueAnimator animDelay={6000}>
                  <div style={{
                    ...
                    {formatShortCurrency(receivables, currency)}
                  </div>
                </KpiValueAnimator>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 2 }}>
                    <div style={{
                      ...
                      â†‘ {currency}{formatShortCurrency(receivables, currency)}
                    </div>
                    <div style={{
                      fontSize: 10,
                      fontWeight: 700,
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <div style={{ fontSize: 12, color: '#dc2626', fontWeight: 600 }}>
                    {lastUnpaidInvoice ? formatShortCurrency(toSafeNumber(lastUnpaidInvoice.totalAmount) - toSafeNumber(lastUnpaidInvoice.paidAmount), currency) : 'K0'}
                  </div>
                  <div style={{ fontSize: 11, color: '#94a3b8', fontWeight: 500 }}>
                    {lastUnpaidInvoice ? format(new Date(lastUnpaidInvoice.date || lastUnpaidInvoice.createdAt), 'MMM d') : 'â€”'}
                  </div>
                </div>
              </div>
            </PremiumKpiCard>
