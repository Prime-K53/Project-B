        ...
        <div className="h-full flex flex-col p-4 md:p-6 max-w-[1600px] mx-auto w-full font-normal overflow-y-auto custom-scrollbar">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6 shrink-0">
                <div className="bg-white/70 backdrop-blur-xl p-4 rounded-2xl border border-white/60 shadow-sm">
                    ...
                    <div className="text-xl font-bold text-slate-900 finance-nums">{currency}{formatNumber(totalValue)}</div>
                ...
                <div className="bg-white/70 backdrop-blur-xl p-4 rounded-2xl border border-white/60 shadow-sm">
                    ...
                    <div className="text-xl font-bold text-slate-900 finance-nums">{currency}{formatNumber(potentialRevenue)}</div>
                    <div className="text-[9px] text-slate-400 mt-1 flex items-center gap-1">
                ...
                <div className="bg-white/70 backdrop-blur-xl p-4 rounded-2xl border border-white/60 shadow-sm">
                    ...
                    <div className="text-xl font-bold text-slate-900 finance-nums">{formatNumber(totalStockUnits)}</div>
                    <div className="text-[9px] text-slate-400 mt-1 flex items-center gap-1">
