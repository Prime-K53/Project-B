        ...
        try {
          ...
          if (syncedInvoicePayload && contactPhone && customerName) {
            await customerNotificationService.triggerNotification('EXAMINATION_INVOICE', {
              ...
              amount: `${companyConfig?.currencySymbol || syncedInvoicePayload.currency || ''}${Number(syncedInvoicePayload.totalAmount || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
