...
export const SalesProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const formatNotificationAmount = (amount?: number) => {
        ...
        return `${companyConfig?.currencySymbol || ''}${numericAmount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`;
    };
    ...
    const convertQuotationToInvoice = async (q: Quotation): Promise<string> => {
        ...
        // âœ… Aggregate adjustment snapshots from all items for margin tracking
        ...
        const invoice: Invoice = {
            ...
            status: 'Unpaid',
            items: invoiceItems,
            // âœ… Add aggregate adjustment data at invoice level for margin reports
