            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-[11px]">
                ...
                <div>
                  ...
                  <p className="font-semibold text-slate-700">{podReceivedAt ? new Date(podReceivedAt).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : 'N/A'}</p>
                </div>
                <div>
            ...
            <div className="mt-6 border-t border-slate-200 pt-8 grid grid-cols-2 gap-8 items-end">
              ...
              <div className="border-b border-slate-300 pb-2">
                ...
                <p className="text-xs font-semibold text-slate-700 mt-1">
                  {podReceivedAt ? new Date(podReceivedAt).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : 'N/A'}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 flex justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-xs font-bold text-slate-700 font-mono">{currency}{statementData.openingBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
              </div>
            </div>
