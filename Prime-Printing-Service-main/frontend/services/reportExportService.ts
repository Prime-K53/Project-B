    ...
    return `
      ...
      <body>
        <div class="header">
          ...
          <div class="meta">
            Generated: ${new Date(result.generatedAt).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
        ...
        <div class="footer">
          <p>Prime ERP System - Report generated on ${new Date().toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
        </div>
