    ...
    if (originalProductionCost > 0 && productionCost > 0) {
      ...
      if (costChangePercent > 0.15) { // >15% change
        console.warn(
          ...
          `K ${originalProductionCost.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} â†’ K ${productionCost.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} ` +
    ...
    if (originalFinalAmount > 0 && updated.final_amount > 0) {
      ...
      if (totalChangePercent > 0.10) { // >10% change
        console.warn(
          ...
          `K ${originalFinalAmount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} â†’ K ${updated.final_amount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} ` +
