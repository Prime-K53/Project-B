  ...
  generatePrintableHTML(
    ...
    let html = `
      ...
      <body>
        ...
        <p>Generated: ${new Date().toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
    `;
      ...
      if (summary.totalDeposits !== undefined) {
        html += `
          <div class="summary-card">
            ...
            <div class="value positive">$${summary.totalDeposits.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
          </div>
          <div class="summary-card">
            <h3>Total Withdrawals</h3>
            <div class="value negative">$${summary.totalWithdrawals.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
          </div>
          <div class="summary-card">
            <h3>Net Change</h3>
            <div class="value ${summary.netChange >= 0 ? 'positive' : 'negative'}">$${summary.netChange.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
          </div>
        `;
      }
      ...
      reportData.transactions.forEach((tx: BankTransaction) => {
        html += `
          <tr>
            ...
            <td>${tx.reference}</td>
            <td>${tx.type}</td>
            <td class="${tx.type === 'Deposit' || tx.type === 'Interest' ? 'positive' : 'negative'}">$${tx.amount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
            <td>${tx.category || '-'}</td>
